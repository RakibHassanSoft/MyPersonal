               ...
               {/* Right section */}
                ...
                <div className="relative text-white w-full md:w-1/2 lg:w-1/2 flex flex-col justify-center p-4 lg:p-12 lg:mr-12">
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        Explore my journey in building dynamic and responsive web applications using technologies like JavaScript, TypeScript, React, Node.js, and MongoDB. <br /> Discover how I integrate creativity and technical expertise to deliver innovative solutions.
